...
public class DBImport {
    ...
    private static class MyJsonConfigHandler {
        private MyJsonConfigHandler(JSONObject configuration) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        new MyJsonConfigHandler(loadConfiguration());
